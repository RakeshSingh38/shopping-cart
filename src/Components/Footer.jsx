        ...
        <div className="px-4 py-20 mt-24 grid grid-cols-1 gap-y-10 lg:grid-cols-4 lg:gap-x-2 border-y-[2px] border-[rgb(219,219,221)] border-solid">
            <div>
                ...
                <p className="mt-4 opacity-90">
                    Marvela, 724, 11th Road, Khar West, Mumbai, Maharashtra
                    400052, India
                </p>
                <p className="opacity-90">bluefashioncompany@gmail.com</p>
            ...
            <div>
                ...
                <form
                    className="sm:flex items-center mt-4 flex flex-col gap-4"
                    onSubmit={(e) => e.preventDefault()}
                >
                    <input
                        type="email"
                        placeholder="Your Email"
                        className="px-[8px] py-[10px] border-black border-[2px] w-full border-solid rounded-full "
                        required
                    />
                    <Button
                        title="Subscribe"
                        class="bg-black text-white px-10 w-full"
                    />
                </form>
            </div>
        </div>
